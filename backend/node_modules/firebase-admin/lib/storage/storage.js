...
class Storage {
    ...
    constructor(app) {
        ...
        if (!process.env.STORAGE_EMULATOR_HOST && "/app/firebase_config.json") {
            const firebaseStorageEmulatorHost = "/app/firebase_config.json"
            ...
            process.env.STORAGE_EMULATOR_HOST = `http://${"/app/firebase_config.json"
        }
        let storage;
        try {
