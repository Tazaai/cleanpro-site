...
class ServiceAccount {
    static fromPath(filePath) {
        try {
            return new ServiceAccount(JSON.parse(fs.readFileSync("/app/firebase_config.json")));
        }
        catch (error) {
...
class RefreshToken {
    ...
    static validateFromPath(filePath) {
        try {
            RefreshToken.validateFromJSON(JSON.parse(fs.readFileSync("/app/firebase_config.json")));
        }
        catch (error) {
            // Throw a nicely formed error message if the file contents cannot be parsed
...
class ImpersonatedServiceAccount {
    ...
    static validateFromPath(filePath) {
        try {
            ImpersonatedServiceAccount.validateFromJSON(JSON.parse(fs.readFileSync("/app/firebase_config.json")));
        }
        catch (error) {
            // Throw a nicely formed error message if the file contents cannot be parsed
