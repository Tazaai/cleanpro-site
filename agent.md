...
up to date, audited 345 packages in 809ms
...
Uploading tarball of [.] to [gs://cleanpro-site_cloudbuild/source/1760305636.930008-8b43f64082c245cea2ae1a67a32932b1.tgz]
Created [https://cloudbuild.googleapis.com/v1/projects/cleanpro-site/locations/global/builds/fabf475f-e2d9-4b36-8120-d0fbeadb09c6].
Logs are available at [ https://console.cloud.google.com/cloud-build/builds/fabf475f-e2d9-4b36-8120-d0fbeadb09c6?project=5539254765 ].
Waiting for build to complete. Polling interval: 1 second(s).
----------------------------- REMOTE BUILD OUTPUT ------------------------------
starting build "fabf475f-e2d9-4b36-8120-d0fbeadb09c6"

FETCHSOURCE
Fetching storage object: gs://cleanpro-site_cloudbuild/source/1760305636.930008-8b43f64082c245cea2ae1a67a32932b1.tgz#1760305663243257
Copying gs://cleanpro-site_cloudbuild/source/1760305636.930008-8b43f64082c245cea2ae1a67a32932b1.tgz#1760305663243257...
...
Step 2/14 : WORKDIR /app/backend
 ---> Running in 755f3b5dbeff
Removing intermediate container 755f3b5dbeff
 ---> 5258bc5724c7
Step 3/14 : COPY package*.json ./
 ---> 2cacd5dcfed0
Step 4/14 : RUN npm install --production
 ---> Running in 6c8b0c119fd1
...
npm notice
[0mRemoving intermediate container 6c8b0c119fd1
 ---> 291203f146f3
Step 5/14 : COPY . .
 ---> a0a46c832409
Step 6/14 : ENV PORT=8080
 ---> Running in 5129f4bf15dd
Removing intermediate container 5129f4bf15dd
 ---> e71cd19f403f
Step 7/14 : ENV CLOUD_RUN_TIMEOUT=1200
 ---> Running in 4b55691d9691
Removing intermediate container 4b55691d9691
 ---> c9b80d57e9cc
Step 8/14 : ENV CLOUD_RUN_CPU_THROTTLING=FALSE
 ---> Running in 737da675b3f1
Removing intermediate container 737da675b3f1
 ---> 8a3d2ca19c84
Step 9/14 : ENV CLOUD_RUN_TIMEOUT=1200
 ---> Running in 19c68d30e3f2
Removing intermediate container 19c68d30e3f2
 ---> c1abef0e4951
Step 10/14 : ENV CLOUD_RUN_TIMEOUT=1200
 ---> Running in 1d3ca4af0945
Removing intermediate container 1d3ca4af0945
 ---> 4955a18ef952
Step 11/14 : ENV CLOUD_RUN_CPU_THROTTLING=FALSE
 ---> Running in 12dfe5d242a1
Removing intermediate container 12dfe5d242a1
 ---> aecfb85d40da
Step 12/14 : ENV CLOUD_RUN_TIMEOUT=1200
 ---> Running in 5125f071745e
Removing intermediate container 5125f071745e
 ---> b007da9b2e79
Step 13/14 : EXPOSE 8080
 ---> Running in 5edc3c440cec
Removing intermediate container 5edc3c440cec
 ---> 78a776c7edbc
Step 14/14 : CMD ["npm","start"]
 ---> Running in bdabfaedf19d
Removing intermediate container bdabfaedf19d
 ---> f8b80a50bc43
Successfully built f8b80a50bc43
Successfully tagged gcr.io/cleanpro-site/cleanpro-backend:latest
PUSH
Pushing gcr.io/cleanpro-site/cleanpro-backend
The push refers to repository [gcr.io/cleanpro-site/cleanpro-backend]
7e5185a6fc9f: Preparing
63059bd728b5: Preparing
e03bfaeca498: Preparing
0d38f3fbb79e: Preparing
...
7e5185a6fc9f: Pushed
63059bd728b5: Pushed
latest: digest: sha256:de8101c349b25f58a172727015c3486e801cb704d73c775dbb7ba23d62ff4c3b size: 2208
DONE
--------------------------------------------------------------------------------
ID                                    CREATE_TIME                DURATION  SOURCE                                                                                       IMAGES                                           STATUS
fabf475f-e2d9-4b36-8120-d0fbeadb09c6  2025-10-12T21:47:43+00:00  2M6S      gs://cleanpro-site_cloudbuild/source/1760305636.930008-8b43f64082c245cea2ae1a67a32932b1.tgz  gcr.io/cleanpro-site/cleanpro-backend (+1 more)  SUCCESS
Deploying container to Cloud Run service [cleanpro-backend] in project [cleanpro-site] region [europe-west1]
Deploying...
Setting IAM Policy.............................done
Creating Revision.................................................................................................................................................................................................................................................................................................failed
Deployment failed
ERROR: (gcloud.run.deploy) Revision 'cleanpro-backend-00532-7j5' is not ready and cannot serve traffic. The user-provided container failed to start and listen on the port defined provided by the PORT=8080 environment variable within the allocated timeout. This can happen when the container port is misconfigured or if the timeout is too short. The health check timeout can be extended. Logs for this revision might contain more information.

Logs URL: https://console.cloud.google.com/logs/viewer?project=cleanpro-site&resource=cloud_run_revision/service_name/cleanpro-backend/revision_name/cleanpro-backend-00532-7j5&advancedFilter=resource.type%3D%22cloud_run_revision%22%0Aresource.labels.service_name%3D%22cleanpro-backend%22%0Aresource.labels.revision_name%3D%22cleanpro-backend-00532-7j5%22 
