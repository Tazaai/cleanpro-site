...
echo "📋 INSTRUCTIONS:"
echo "================"
echo "This script will help you validate your Firebase service account JSON"
echo "and prepare it for Base64 encoding for GitHub Secrets."
echo ""
...
echo ""
echo "2. Choose validation method:"
echo ""
